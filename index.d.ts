  ...
  type MapFromDataCallback<R, B, D> = (
    stateData: Arcsecond.StateData<R, D>
  ) => B;
  ...
  export namespace Arcsecond {
     ...
     */
    export const setData: <D>(data: D) => Parser<null, D>;
    ...
    export const withData: <P>(
      ...
      data: D
    ) => Parser<ExtractParserResult<P>, D, ExtractParserError<P>>;
     ...
     */
    interface Choice {
      // Only applies for the case where all subparsers are of the same type
      <P1 extends AnyParser>(parsers: P1[]): Parser<
        ExtractParserResult<P1>,
        any,
        any
    ...
    export const sepBy: (
      ...
      valueParser: P
    ) => Parser<Array<ExtractParserResult<P>>, any, any>;
     ...
     * takes a termination parser and returns a new parser which matches
     * every possible character up until a value is matched by the termination parser.
     * When a value is matched by the termination parser, it is not "consumed".
     */

    export const everyCharUntil: <P extends AnyParser>(
      terminationParser: P
    ) => Parser<ExtractParserResult<P>, any, any>;

    /**
     * `Parser e a s -> Parser e Char s`
     * Note: Between 2.x and 3.x, the definition of the anythingExcept has changed.
     * In 3.x, what was previously anythingExcept is now anyCharExcept.
     * anythingExcept takes a exception parser and returns a new parser
     * which matches exactly one numerical byte, if it is not matched by the exception parser.
     */
     ...
     */
    export const anyCharExcept: <P extends AnyParser>(
      exceptionParser: P
    ) => Parser<ExtractParserResult<P>, any, any>;
     ...
     */
    export const anyChar: Parser<string, any, any>;
